...
run_name_template: "%Y%m%d-%H%M%S-checkpoint-for-example"
validations:
  - batch_request:
      datasource_name: {datasource_name }
      data_connector_name: default_inferred_data_connector_name
...
testing_file_name = "yellow_tripdata_sample_2019-02.csv"
my_new_checkpoint_config = f"""
name: checkpoint on testing file
config_version: 1.0
class_name: SimpleCheckpoint
run_name_template: "%Y%m%d-%H%M%S-checkpoint-for-testing-file"
validations:
  - batch_request:
      datasource_name: {datasource_name }
      data_connector_name: default_inferred_data_connector_name
